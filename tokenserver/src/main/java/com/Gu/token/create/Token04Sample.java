...
import com.Gu.token.utils.TokenServerAssistant;
...
public class Token04Sample {
    ...
    private static final long appId = 602618791;    // 请替换为你的 appId，从即构控制台获取
    private static final String serverSecret = "24c0b4f0d29cdfd502d87b5b99d7d7ce";  // 请替换为你的 serverSecret，从即构控制台获取，
    private static final int effectiveTimeInSeconds = 300;   // 有效时间，单位：秒


    /**
     *
     * @param userId:为用户的 userID，同一 appId 下全网唯一
     * @return token:鉴权
     */
    public String CreateToken(String userId) {
        ...
        TokenServerAssistant.TokenInfo token = TokenServerAssistant.generateToken04(appId,  userId, serverSecret, effectiveTimeInSeconds, null);
